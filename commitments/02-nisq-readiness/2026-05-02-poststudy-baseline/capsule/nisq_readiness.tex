...
\begin{enumerate}
  ...
  \item We quantify cross-backend workload-ranking structure across 28 complete six-backend workload kinds within the IBM corpus and show that deterministic permutation sensitivity retains 14/15 Bonferroni-significant backend pairs, while the analytic Spearman test gives 15/15 and identifies the weakest pair as borderline under permutation.
...
The author-declared evaluation plan is preserved in the public ancillary/release surface. The reconciled evidence capsule is archived at Zenodo DOI \href{https://doi.org/10.5281/zenodo.19954164}{10.5281/zenodo.19954164}, providing a stable third-party archive for the release package, but that DOI is a release timestamp rather than an independent pre-execution registry timestamp. For the next campaign, the evaluation-plan hash will be committed on day zero to a public repository surface and to an external transparency log such as Rekor or OpenTimestamps.
