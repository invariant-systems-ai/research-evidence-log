...
2. mirror the same hash to an external transparency log such as Rekor or OpenTimestamps
3. record the transparency-log entry in the campaign directory
4. never rewrite history for prior commitments

Canonical URL:
- https://github.com/invariant-systems-ai/public-plan-commitments